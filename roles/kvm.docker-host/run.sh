#        copy: ./copy.txt ./xexecscript.d/add-loopdev/copy.txt
#    postcopy: ./postcopy.txt
# xexecscript: ./xexecscript.d/docker-io/xexecscript.d/01_hop5-repo/xexecscript.d/hop5-repo.sh ./xexecscript.d/docker-io/xexecscript.d/docker-io.sh ./xexecscript.d/sshd_config/xexecscript.d/sshd_config.sh
#   firstboot: 
#   everyboot: 
#!/bin/sh -e
#execute kvm command
